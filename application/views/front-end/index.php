...
<!-- //for-mobile-apps -->
<link href="assets/front-end/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
...
<!-- //js -->
<!-- cart -->
<script src="assets/front-end/js/simpleCart.min.js"></script>
<!-- cart -->
<!-- for bootstrap working -->
<script type="text/javascript" src="assets/front-end/js/bootstrap-3.1.1.min.js"></script>
<!-- //for bootstrap working -->
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
<!-- timer -->
<link rel="stylesheet" href="assets/front-end/css/jquery.countdown.css" />
<!-- //timer -->
<!-- animation-effect -->
<link href="assets/front-end/css/animate.min.css" rel="stylesheet"> 
<script src="assets/front-end/js/wow.min.js"></script>
<script>
 new WOW().init();
</script>
<!-- //animation-effect -->
		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:hello@autoshop.com">hello@autoshop.com</a></li>
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.html">&nbsp;&nbsp;Auto Store <span>Cars &amp; Accesories</span></a></h1>
				</div>
				<div class="logo-nav-left1">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li><a href="short-codes.html">How To Shop</a></li>
				...
				<div class="logo-nav-right">
					<div class="search-box">
						...
						<!-- search-scripts -->
						<script src="assets/front-end/js/classie.js"></script>
						<script src="assets/front-end/js/uisearch.js"></script>
							<script>
					...
					<div class="cart box_1">
						<a href="checkout.html">
							<h3> <div class="total">
								...
								<img src="assets/front-end/images/bag.png" alt="" />
							</h3>
						</a>
			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
					...
					<div class="footer-grid-left">
						<a href="single.html"><img src="assets/front-end/images/13.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="assets/front-end/images/14.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="assets/front-end/images/15.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="assets/front-end/images/16.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="assets/front-end/images/13.jpg" alt=" " class="img-responsive" /></a>
					</div>
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".8s">
					...
					<div class="footer-grid-sub-grids">
						<div class="footer-grid-sub-grid-left">
							<a href="single.html"><img src="assets/front-end/images/9.jpg" alt=" " class="img-responsive" /></a>
						</div>
					...
					<div class="footer-grid-sub-grids">
						<div class="footer-grid-sub-grid-left">
							<a href="single.html"><img src="assets/front-end/images/10.jpg" alt=" " class="img-responsive" /></a>
						</div>
						<div class="footer-grid-sub-grid-right">
